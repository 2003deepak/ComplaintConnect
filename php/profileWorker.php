...
<!-- It is used to display the count of new request and pending as well as completed requests -->
    ...
    <div class="content">
        ...
        <div class="bottom">
            <div class="left">
                ...
                $username_search = "SELECT * FROM worker WHERE username = '" . $_SESSION['username'] . "'";
                ...
                if($username_count){
                    ...
                    $pincode = $query1['pincode'];
                    $email = $query1['email'];
                    $mobile_number = $query1['mobile_number'];
                    $work_area = $query1['work_area'];
                ...
                ?>
                    ...
                    <div class="address">
                        ...
                        <div class="addressTop">
                            <p>Address</p>
                            <textarea rows="4" cols="90" placeholder="Flat / House No / Building Name "  name = "address" ><?php echo $address; ?></textarea>  
                        </div>
                        <div class="areaPin">
                            <input type="text" name="area" placeholder="Area" >
                            <input type="number" name="pincode" placeholder="Pincode" value="<?php echo $pincode; ?>" >
                        </div>
                    ...
                    <div class="areaContact">
                        ...
                        <div class="areaContactleft">
                            <p>Work Area</p>
                            <input type="text" name="work_area" placeholder="Water" value="<?php echo $work_area; ?>">
                ...
                <div class="profile">
                    ...
                    <div>
                        <div class="profileleft">
                            ...
                            <img src="../images/file-add.svg" alt="" height="30px" width="30px" id="img">
                            <p>Upload New</p>
    ...
    <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save'])) {
                    ...
                    $sql = "UPDATE worker SET `name` = '$name', `last_name` = '$last_name',`Address` = '$address' , `pincode` = '$pincode' , `mobile_number` = '$mobile_number' WHERE `username` = '" . $_SESSION['username'] . "'";
                    ...
                    if ($conn->query($sql) === TRUE) {
                        echo '<script>';
                        echo 'ConfirmationAlert("Success","Profile Updated","../php/profileWorker.php")';
                        echo '</script>';
                    } else {
                        echo '<script>';
                        echo 'ErrorAlert("Failed","Updation Failed","../php/profileWorker.php")';
                        echo '</script>';
