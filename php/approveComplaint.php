        ...
        <table class="table bg-transparent text-white ">
            ...
            <?php
              ...
              <tr>
                ...
                <td class=" col-2 "><a type="button" class="btn btn-primary" style = "background:#FF9F00 ; border:none; color:black;" href="../php/adminApproveComplaint.php?action=approve&id=<?php echo $row['complaint_id']; ?>">Approve</a></td>
                
                <td class=" col-2 "><a type="button" class="btn btn-primary" style = "background:#FF9F00 ; border:none; color:black;" href="../php/adminApproveComplaint.php?action=disapprove&id=<?php echo $row['complaint_id']; ?>">Dissaprove</a></td>
