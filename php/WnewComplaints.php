        ...
        <table class="table bg-transparent text-white ">
            ...
            <?php
              ...
              <tr>
                ...
                <td class=" col-2 "><a type="button" class="btn btn-primary" style = "background:#FF9F00 ; border:none; color:black;" href="../php/takeAction.php?id=<?php echo $row['complaint_id']; ?>">Take Actions</a></td>
